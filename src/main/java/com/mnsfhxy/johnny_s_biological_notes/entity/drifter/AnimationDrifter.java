...
public class AnimationDrifter {
    public static final AnimationDefinition DRIFTERS_HOSTILE = AnimationDefinition.Builder.withLength(2.5F).looping()
            .addAnimation("rightarm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-15.0F, 0.0F, 7.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.25F, KeyframeAnimations.degreeVec(-22.5F, 0.0F, 7.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.5F, KeyframeAnimations.degreeVec(-15.0F, 0.0F, 7.0F), AnimationChannel.Interpolations.LINEAR)
            ))
    ...
    public static final AnimationDefinition DRIFTERS_WALKING_NEW = AnimationDefinition.Builder.withLength(2.5F).looping()
            ...
            .build();
    public static final AnimationDefinition DRIFTERS_ALERT = AnimationDefinition.Builder.withLength(2.5F).looping()
            ...
            .addAnimation("arms2", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(4.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("arms3", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            .build();
    public static final AnimationDefinition DRIFTERS_FIGHT = AnimationDefinition.Builder.withLength(2.5F)
            .addAnimation("rightarm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-15.0F, 0.0F, 7.0F), AnimationChannel.Interpolations.LINEAR),
                    ...
                    new Keyframe(0.8333F, KeyframeAnimations.degreeVec(-15.0F, 0.0F, 7.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .build();
}
