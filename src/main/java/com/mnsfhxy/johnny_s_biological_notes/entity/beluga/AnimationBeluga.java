...
public class AnimationBeluga {
    public static final AnimationDefinition SWIMMING = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("tell1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            .addAnimation("tell1", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            .addAnimation("tell2", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition TOUCHED = AnimationDefinition.Builder.withLength(1.0F)
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
    ...
    public static final AnimationDefinition ATTACKING = AnimationDefinition.Builder.withLength(0.7083F)
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.2917F, KeyframeAnimations.posVec(0.0F, 0.0F, -4.25F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.1667F, KeyframeAnimations.degreeVec(22.5F, 0.0F, 13.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.2917F, KeyframeAnimations.degreeVec(-5.74F, 0.0F, -12.0F), AnimationChannel.Interpolations.CATMULLROM),
