...
public class ChopParticle  extends TextureSheetParticle {
    ...
    protected ChopParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pQuadSizeMultiplier, SpriteSet pSprites) {
    ...
    private final SpriteSet spirtes;
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new ChopParticle(pLevel,pX,pY,pZ, pXSpeed,spirtes);
        }
    }
}
